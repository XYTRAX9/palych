...
from database.dependencies import get_techcard_db  # вместо from main import
...
def get_groups(db: Session = Depends(get_techcard_db)):
    """
...
def get_lessons(db: Session = Depends(get_techcard_db)):
    """
...
def get_teachers(db: Session = Depends(get_techcard_db)):
    """
...
def get_lesson_types(db: Session = Depends(get_techcard_db)):
    """
...
def get_skills_knowledge(db: Session = Depends(get_techcard_db)):
    """
